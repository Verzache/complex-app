// Client side js to validate form live also for good user experience
...
export default class RegistrationForm {
  ...
  events() {
    ...
    // blur runs when a field exits focus
    // prevents invalid data to submit in frontend
  ...
  passwordImmediately() {
    if (this.password.value.length > 15) {
      this.showValidationError(this.password, "Password cannot exceed 15 characters.")
    }
  ...
  usernameImmediately() {
    ...
    if (this.username.value.length > 10) {
      this.showValidationError(this.username, "Username cannot exceed 10 characters.")
    }
